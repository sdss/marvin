...
#         self._test_getspaxel(spaxel, galaxy)
#         assert spaxel.getCube() is None
#         assert spaxel.spectrum is None
#         assert spaxel.getMaps() is None
...
#
#         assert pytest.approx(spaxel_slice_file.model_flux.binned_flux[idx], flux)
#         assert pytest.approx(spaxel_slice_db.model_flux.binned_flux[idx], flux)
#         assert pytest.approx(spaxel_slice_api.model_flux.binned_flux[idx], flux)
#
...
#
#         assert pytest.approx(spaxel_getspaxel_file.model_flux.binned_flux[idx], flux)
#         assert pytest.approx(spaxel_getspaxel_db.model_flux.binned_flux[idx], flux)
#         assert pytest.approx(spaxel_getspaxel_api.model_flux.binned_flux[idx], flux)
#
