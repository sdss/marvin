...
MPL4_emline_channels = [
    Channel('oiid_3728', formats={'string': 'OIId 3728',
                                  'latex': r'\[O\,IId\]\;\lambda 3728'}, idx=0,
